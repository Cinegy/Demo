...
$xmlSetOp1Elem.InnerText = "D:\Data\Type\Alert Template.CinType";
$xmlSetValueElem.AppendChild($xmlSetOp1Elem);

$xmlSetOp2Elem = $xmlDoc.CreateElement('Op2');
$xmlSetOp2Elem.InnerText = "This is a 21°C day"
...
$xmlDoc.OuterXml | Out-File "T:\xmldoc.xml"